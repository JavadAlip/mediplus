...
const Chat = () => {
  ...
  return (
    <section className='pt-[160px] h-screen bg-gray-100 flex justify-center items-center'>
      {chatActive ? (
        <div className='rounded-md w-full md:w-[80vw] lg:w-[40vw] mx-auto'>
          <h1 className='font-bold text-primaryColor text-center text-xl my-2 uppercase'>MEDIPLUS CHAT</h1>
          <div className="overflow-y-scroll h-[80vh] lg:h-[60vh]">
          ...
          <div className='gap-1'>
            <form className='flex gap-2 md:gap-2 justify-between' onSubmit={handleSubmit}>
              <input type="text"
                placeholder='Your message...'
                className='px-3 py-2 w-full border-1 outline-none rounded-md'
                value={newMessage}
                onChange={(e) => setNewMessage(e.target.value)} />
              <button type='submit' className='bg-primaryColor text-white px-3 py-2 border-none outline-none rounded-md'>
                Send
              </button>
            </form>
          </div>
        ...
        <div className='flex justify-center items-center gap-1'>
          <input type="text"
            className='text-center px-3 py-2 border-none outline-none rounded-md'
            placeholder='Username'
            value={username}
            onChange={(e) => setUsername(e.target.value)} />
          <button
            className='bg-primaryColor text-white px-3 py-2 border-none outline-none rounded-md'
