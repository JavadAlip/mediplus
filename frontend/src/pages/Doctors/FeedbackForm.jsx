...
const FeedbackForm = () => {
    ...
    return <form action="">
        <div>
            <h3 className="text-primaryColor text-[16px] mt-5 leading-6 font-semibold mb-4">
        ...
        <button type="submit" onClick={handleSubmitReview} className="btn">{ loading ? <HashLoader size={24} color='#fff'/>:"Submit Feedback"}</button>
    </form>
}
