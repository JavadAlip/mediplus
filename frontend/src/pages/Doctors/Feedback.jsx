            ...
            <div className="flex justify-between gap-10 mb-[30px]">
                <div className="flex gap-3">
                    ...
                    <div>
                        ...
                        <p className="text__para mt-2 font-medium text-[15px] text-textColor">Good Services, Fully Satisfied.</p>
                    </div>
                </div>

                <div className="flex gap-1]">
                    {[...Array(5).keys()].map((_, index) => <AiFillStar key={index} color='#20297D' />)}
                </div>
            </div>
        </div>
